<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button type="primary" class="group-audit filter-item" @click="auditGroup">添加</el-button>
      <el-button type="primary" class="group-audit filter-item" @click="auditGroup">删除</el-button>
      <!-- $t是用与语言转换的 -->
      <el-input
